...
<div className="review-page">
  <div className="review-card">
    ...
    <h1 className="text-2xl font-bold mb-3">Leave a Review</h1>
    ...
    <div className="flex justify-center gap-2 mb-3">
      {[1,2,3,4,5].map((star)=>(
        <span
          ...
          className={`star ${star<=rating?"active":"text-gray-500"}`}>
          ★
        </span>
      ))}
    </div>
    ...
    <textarea
      ...
      className="w-full p-3 rounded bg-transparent border mb-4"
    />

    <button
      onClick={handleSubmit}
      className="w-full py-2 rounded bg-linear-to-r from-blue-500 to-cyan-400">
      Submit Review
    </button>
