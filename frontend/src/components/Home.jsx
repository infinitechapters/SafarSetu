...
//               <img className="about-img" src={img1} alt="travel" />
//               <div className="about-img-overlay" />
//             </div>
//             <div className="about-img-wrap">
//               <img className="about-img" src={img2} alt="travel" />
//               <div className="about-img-overlay" />
//             </div>
//             <div className="about-img-wrap">
//               <img className="about-img" src={img3} alt="travel" />
//               <div className="about-img-overlay" />
//             </div>
//           </div>
//         </div>
    ...
    <>
      ...
      <section className="hero" ref={heroRef}>
        ...
        <div className="hero-body">
          ...
          {/* live destination ticker — visible above the fold on load, so kept eager */}
          <div className="hero-right">
            <div className="dest-ticker">
              <div className="ticker-header">
                <span className="ticker-live" />
